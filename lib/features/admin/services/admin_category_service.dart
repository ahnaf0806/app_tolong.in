...
class AdminCategoryService {
  ...
  Future<void> createCategory({
    ...
    await _client.from('project_categories').insert({
      'name': name.trim(),
  ...
  Future<void> deleteCategory({
    required AdminCategoryItemModel category,
  }) async {
    await _adminGuard.assertAdminAccess();

    if (!category.canDelete) {
      throw Exception(
        'Kategori tidak bisa dihapus karena sudah dipakai ${category.projectCount} project.',
      );
    }
